...
namespace cloud.charging.open.API
{
    ...
    /// <summary>
    /// The Open Charging Cloud CSO API.
    /// </summary>
    public class OpenChargingCloudCSOAPI : OpenChargingCloudAPI
    {
        ...
        public OpenChargingCloudCSOAPI(String                               ServiceName                        = "GraphDefined Open Charging Cloud CSO API",
            ...
            : base(ServiceName:                       ServiceName                 ?? "GraphDefined Open Charging Cloud CSO API",
                   HTTPServerName:                    HTTPServerName              ?? "GraphDefined Open Charging Cloud CSO API",
        ...
        ///// <param name="DNSClient">The DNS client of the API.</param>
        ///// <param name="Autostart">Whether to start the API automatically.</param>
        //public OpenChargingCloudCSOAPI(String                               HTTPServerName                     = DefaultHTTPServerName,
        ...
        #region OpenChargingCloudCSOAPI(HTTPServer, HTTPHostname = null, URIPrefix = null, ...)
        ...
        ///// <param name="DisableLogfile">Disable the log file.</param>
        ///// <param name="LogfileName">The name of the logfile for this API.</param>
        //public OpenChargingCloudCSOAPI(HTTPServer                           HTTPServer,
        //                               HTTPHostname?                        HTTPHostname                  = null,
        //                               HTTPPath?                            URIPrefix                     = null,
