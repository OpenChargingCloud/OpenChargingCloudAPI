...
namespace cloud.charging.open.API
{
    ...
    //    public HTTPEventSource<JObject>                     DebugLog                     { get; }
        ...
        /// </summary>
        public HTTPRequestLogEvent OnGetEVSEsRequest = new();
        ...
        /// </summary>
        public HTTPResponseLogEvent OnGetEVSEsResponse = new();
                ...
                HTTPDelegate: request => {
                    ...
                    return Task.FromResult(
                        new HTTPResponse.Builder(request) {
                            ...
                            X_ExpectedTotalNumberOfItems  = (UInt64) allResults.Length,
                            Connection                    = ConnectionType.KeepAlive
                        }.AsImmutable);
                    ...
                    return Task.FromResult(
                        new HTTPResponse.Builder(request) {
                            ...
                            Content                      = JSONObject.Create(
                                                               ...
                                                               new JProperty("count",   allResults.Length),
