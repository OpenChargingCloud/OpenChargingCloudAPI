...
namespace cloud.charging.open.protocols.WWCP.Net.UnitTests
{
    ...
    /// <summary>
    /// E-mobility provider WWCP HTTP Unit Tests.
    /// </summary>
    [TestFixture]
    public class EMobilityProviderTests : ATests
    {
        ...
        public void CREATE()
        {
            ...
            #region Verify GET   /RNs/TestRN1/EMobilityProviders

            var URI = HTTPPath.Parse("/RNs/TestRN1/EMobilityProviders");
            ...
            #region Verify COUNT /RNs/TestRN1/EMobilityProviders
