...
namespace cloud.charging.open.protocols.WWCP.Net.UnitTests
{
    ...
    /// <summary>
    /// Charging Pool WWCP HTTP Unit Tests.
    /// </summary>
    [TestFixture]
    public class ChargingPoolTests : ATests
    {
        ...
        public void CREATE()
        {
            ...
            #region Verify GET   /RNs/TestRN1/ChargingPools

            var URI = HTTPPath.Parse("/RNs/TestRN1/ChargingPools");
            ...
            #region Verify COUNT /RNs/TestRN1/ChargingPools
